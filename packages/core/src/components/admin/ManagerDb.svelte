<script>
    ...
    import { setParams, formatPhoneNumber } from "$core/lib.js";
    ...
    $effect(() => {
        ...
        site_list = siteData.site_list;
        status_list = siteData.statusArr;
    ...
    function searchFunc(e) {
        ...
        const getMoveUrl = setParams(paramOption, true);
