<script>
    ...
    import { setParams, createArray } from "$core/lib.js";
    ...
    let siteListOpt = $state(siteData.siteList);
    ...
    $effect(() => {
        minisiteData = siteData.minisiteData;
        pageArr = siteData.pageArr;
    ...
    function searchFunc() {
        const moveUrl = setParams({ search: searchVal }, true);
